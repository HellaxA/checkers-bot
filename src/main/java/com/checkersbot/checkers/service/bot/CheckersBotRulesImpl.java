...
public class CheckersBotRulesImpl implements CheckersBotRules {
    ...
    public List<Move> getPseudoAvailableMoves(String teamColor, Checker[] checkers) {
        this.teamColor = teamColor;
        List<Move> pseudoAvailableMoves = getAllAvailableMoves(checkers, teamColor);

        return pseudoAvailableMoves;
    }


    public List<Move> getAllAvailableMoves(Checker[] checkers, String teamColor) {
        this.teamColor = teamColor;
